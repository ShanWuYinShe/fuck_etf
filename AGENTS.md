...
- **大盘环境三级（8.1）**：指数收于 20 日线上方=正常；跌破/20日线拐头=谨慎（新开仓盈亏比≥2.0、仓位≤1/4、只减不加）；连续3日线下方=保守（停新开仓、减至半仓以下）。
- **止损锚结构位**：止损价=关键支撑（10日低/平台/20日线）下方1个价差档；自动条件单只作灾难兜底，战术离场 14:45 后人工确认；尾盘收回支撑上方=假破位不止损。
